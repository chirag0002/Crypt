          ...
          <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism ">
            <div className="flex justify-between flex-col w-full h-full">
              <div className="flex justify-between items-start">
                <div className="w-10 h-10 rounded-full border-2 border-[purple] flex justify-center items-center">
                  <IoLogoPolymer fontSize={24} color="purple" />
                </div>
            ...
            {isLoading ? (
              <Loader />
                ...
                <button
                  ...
                  className="text-white w-full mt-2 border-[1px] p-2 border-[#3d4f9c] bg-[#2952e3] hover:bg-[#2546bd] rounded-full cursor-pointer"
                >
                  Send now
                </button>
            )}
